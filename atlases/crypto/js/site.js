...
(function(){
  ...
  const NAVPAGES = [
    ...
    {p:'fieldeng',   href:'fieldeng.html',     en:'Field Engineering',      uk:'Інженерія полів'},
    ...
    {p:'prngtest',   href:'prngtest.html',     en:'Randomness Tests',       uk:'Тести ГВЧ'},
    ...
    {p:'hashsig',    href:'hashsig.html',      en:'Hash Signatures',        uk:'Геш-підписи'},
    {p:'kex',        href:'keyexchange.html',  en:'Key Exchange',           uk:'Обмін ключами'},
    {p:'kdf',        href:'kdf.html',          en:'Key Derivation',         uk:'KDF'},
    {p:'authproto',  href:'authprotocols.html',en:'Authentication',         uk:'Автентифікація'},
    ...
    {p:'mpc',        href:'mpc.html',          en:'Multiparty Computation', uk:'Обчислення'},
    ...
    {p:'symanalysis',href:'symcrypt.html',     en:'Symmetric Analysis',     uk:'Аналіз шифрів'},
    ...
    {p:'worldciphers',href:'worldciphers.html',en:'World Standards',        uk:'Світові'}
  ];
